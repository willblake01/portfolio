...
const About = () => (
  <>
    ...
    <Grid2 size={7} spacing={2} sx={{ display: 'flex', height: 'max-content', justifyContent: 'center' }}>
      <Card sx={{ borderRadius: 2, padding: '24px', width: '800px' }}>
    ...
    <Grid2 size={5} spacing={2} sx={{ display: 'flex' }}>
      <Box sx={{ display: 'flex' }}>
        <img src='https://res.cloudinary.com/willblake01/image/upload/v1732640647/profile-pic.jpg' alt='profile-pic' style={{ height: 'max-content', width: '400px' }} />
      </Box>
    </Grid2>
  </Grid2>
  </>
